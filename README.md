...
血量初始 20，月份无上限，净得分仅展示双方血量差，不据此判胜。全善／全恶直接结束游戏，不触发善恶决战（优先于血量归零）。

| 环境 | 效果 | 下个月 |
| --- | --- | --- |
| 普通月（起始环境） | 基础八项规则不变 | 以勇者 vs 魔王或勇者 vs 善良结束 → 朗月；否则仍普通月 |
| 朗月 | 勇者 vs 魔王：勇者 +5／魔王 −5，不交换；勇者 vs 邪恶及邪恶 vs 邪恶：勇者不掉血，仍感化 | 一定为血月 |
| 血月 | 勇者 vs 邪恶：勇者 −6；邪恶 vs 邪恶：勇者 −4；所有邪恶均不感化，善恶交换归属和魔王腐化仍生效；勇者 vs 魔王：无伤害无回血，直接交换血量 | 一定为普通月 |

环境只在月份结束并且双方确认下一月时切换。本月市民对决后进入下一回合不会改变环境。规则矩阵按当前环境展示全部组合，日志逐条保存结算时环境，以不同颜色的【普通月】【朗月】【血月】显示；善恶决战日志使用金色标签。
